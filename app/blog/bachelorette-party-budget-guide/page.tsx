...
export default function BachelorettePartyBudgetGuidePage() {
    return (
        <article className="max-w-3xl mx-auto py-8 px-4">
            <BlogPostJsonLd
                title="The Ultimate Bachelorette Party Budget Guide (2026)"
                description="Planning a bachelorette party? Here's how to budget for the bride tribe, split costs fairly, and throw an unforgettable celebration without breaking the bank."
            ...
            <BreadcrumbJsonLd
                items={[
                    ...
                    { name: "Bachelorette Budget Guide", url: "https://partytab.app/blog/bachelorette-party-budget-guide" },
                ]}
            />
